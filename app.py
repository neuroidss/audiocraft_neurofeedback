        ...
        with gr.Row():
            with gr.Column():
                ...
                with gr.Row():
                    ...
                    time_shift = gr.Slider(minimum=0, maximum=10000, value=1800, step=1, label="Time Shift", interactive=True)
                with gr.Row():
